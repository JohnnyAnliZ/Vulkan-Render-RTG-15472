...
struct Helpers {
	...
	//allocate a block that works with given VkMemoryRequirements and VkMemoryPropertyFlag
	Allocation allocate(VkMemoryRequirements const &req, VkMemoryPropertyFlags properties, MapFlag map = Unmapped);
