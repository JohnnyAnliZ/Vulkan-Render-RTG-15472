...
#include "spv/rayMarchSmoke.frag.inl"
;

void RayMarchSmokeVolumePipeline::create(RTG &rtg, VkRenderPass render_pass, uint32_t subpass){
    VkShaderModule vert_module = rtg.helpers.create_shader_module(vert_code);
    VkShaderModule frag_module = rtg.helpers.create_shader_module(frag_code);


    { //the set0_density_volume layout holds the vector_volume
    ...
    //inpute assembly state structure (how will the pipeline draw)
    ...
    //configure rasterizer to do back face culling
...
void RayMarchSmokeVolumePipeline::destroy(RTG &rtg){
